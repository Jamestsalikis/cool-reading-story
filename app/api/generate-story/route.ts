...
"Disney Pixar 3D animated movie style, large expressive eyes, smooth rounded cartoon features, cel-shaded vibrant saturated colours, warm soft cinematic lighting, magical storybook atmosphere, professional Disney feature film quality. ${name}, a ${age}-year-old child with [EXACT HAIR: colour + style e.g. 'curly auburn hair'], wearing [EXACT OUTFIT: name every piece with specific colours e.g. 'a bright cobalt-blue hoodie with a yellow star, forest-green cargo shorts, and orange high-top sneakers']  -  same character, same face, same exact outfit in every image."
