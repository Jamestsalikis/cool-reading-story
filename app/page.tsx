    ...
    <div style={{ background: '#FFF4E6', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 2rem 3rem' }}>
        <div className="hero-grid">
          ...
          {/* Left: copy + widget */}
          <div>
            <h1 style={{ fontFamily: '"Fredoka One", "Arial Rounded MT Bold", cursive', fontWeight: 900, fontSize: 'clamp(2.4rem, 6vw, 4rem)', lineHeight: 1.08, color: '#0D183D', marginBottom: '1.25rem', letterSpacing: '0.02em', textShadow: '0 6px 14px rgba(8,14,34,0.18)' }}>
