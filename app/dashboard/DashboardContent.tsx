    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
          <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.15rem', color: '#0D183D', lineHeight: 1.25, flex: 1, paddingRight: '8px' }}>
            {current.title}
          </h3>
      ...
      <div className="book-wrap" onClick={() => router.push(`/stories/${story.id}`)}
        ...
        <div style={{ position: 'relative', width: '140px', height: '196px', transformStyle: 'preserve-3d' }}>
          ...
          <div style={{ position: 'absolute', left: '18px', top: 0, width: 'calc(100% - 18px)', height: '100%', borderRadius: '0 6px 6px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '16px 12px', gap: '8px', overflow: 'hidden', background: '#FFF8F0' }}>
            ...
            <p style={{ position: 'relative', zIndex: 1, fontSize: '0.72rem', fontFamily: 'Nunito, sans-serif', textAlign: 'center', color: '#0D183D', lineHeight: 1.45 }}>{story.title}</p>
          ...
          <div className="book-cover-panel" style={{ position: 'absolute', left: '18px', top: 0, width: 'calc(100% - 18px)', height: '100%', background: palette.cover, borderRadius: '0 6px 6px 0', transformOrigin: 'left center', backfaceVisibility: 'hidden', zIndex: 2, overflow: 'hidden', boxShadow: '3px 3px 14px rgba(0,0,0,0.22)' }}>
            {coverImage ? (
              <>
                ...
                <p style={{ position: 'absolute', bottom: '22px', left: '8px', right: '8px', fontSize: '0.7rem', fontFamily: 'Nunito, sans-serif', color: '#fff', lineHeight: 1.35, textShadow: '0 1px 4px rgba(0,0,0,0.7)', zIndex: 1 }}>{story.title}</p>
              ...
              <>
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '16px 12px', gap: '8px' }}>
                  ...
                  <p style={{ fontSize: '0.75rem', fontFamily: 'Nunito, sans-serif', textAlign: 'center', color: 'rgba(255,255,255,0.95)', lineHeight: 1.4 }}>{story.title}</p>
              ...
              <div style={{ position: 'absolute', left: '13px', top: 0, width: 'calc(100% - 13px)', height: '100%', background: palette.cover, overflow: 'hidden' }}>
                ...
                {!coverImage && (
                  <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px 8px' }}>
                    <p style={{ fontSize: '0.56rem', fontFamily: 'Nunito, sans-serif', color: 'rgba(255,255,255,0.9)', textAlign: 'center', lineHeight: 1.3 }}>{vol.title.length > 36 ? vol.title.slice(0, 34) + '…' : vol.title}</p>
                  </div>
                )}
                <p style={{ position: 'absolute', bottom: '18px', left: '5px', right: '5px', fontSize: '0.52rem', fontFamily: 'Nunito, sans-serif', color: '#fff', textAlign: 'center', zIndex: 2, textShadow: '0 1px 3px rgba(0,0,0,0.8)' }}>{vol.title.length > 30 ? vol.title.slice(0, 28) + '…' : vol.title}</p>
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 1000, background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(3px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: '#FFFEF9', borderRadius: '16px', padding: '28px', maxWidth: '560px', width: '100%', maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 24px 60px rgba(0,0,0,0.2)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.3rem', color: '#0D183D' }}>Edit {child.name}&apos;s profile</h2>
    ...
    <div style={{ minHeight: '100vh', background: '#FFF4E6' }}>
      ...
      {generating && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(13,10,8,0.93)', zIndex: 100, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', padding: '24px' }}>
          ...
          <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.3rem, 4vw, 1.8rem)', color: '#FFB703', textAlign: 'center', lineHeight: 1.3 }}>
      ...
      <div style={{ padding: isMobile ? '24px 16px 100px' : '40px 48px 60px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {!loading && children.length > 0 && activeNav === 'stories' && (
          <div style={{ marginBottom: '32px' }}>
            <h2 style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.6rem, 4vw, 2.4rem)', color: '#0D183D', fontWeight: '400', marginBottom: '6px' }}>
          ...
          <>
            ...
            {loading ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px', padding: '80px 0' }}>
                ...
                <p style={{ color: '#5E6A7A', fontFamily: 'Nunito, sans-serif', fontSize: '1.1rem' }}>Loading your library...</p>
              </div>
            ) : children.length === 0 ? (
              <div style={{ maxWidth: '420px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', margin: '60px auto 0' }}>
                ...
                <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.6rem', color: '#0D183D', marginBottom: '8px' }}>Your library is empty!</h3>
                ...
                {mostRecentStory && (
                  <div className="continue-card" onClick={() => router.push(`/stories/${mostRecentStory.id}`)}
                    ...
                    <div style={{ position: 'absolute', bottom: '24px', left: '28px' }}>
                      ...
                      <p style={{ fontFamily: 'Nunito, sans-serif', fontSize: 'clamp(1.1rem, 3vw, 1.5rem)', color: '#fff', marginBottom: '14px', lineHeight: 1.2, maxWidth: '400px', textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>
                    ...
                    <div key={child.id} id={childIndex === 0 ? 'tour-shelf' : undefined}>
                      <div style={{ background: palette.light, borderRadius: '16px', padding: '16px 20px', marginBottom: '28px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                          ...
                          <div>
                            <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.3rem', color: '#0D183D', fontWeight: '400', marginBottom: '2px' }}>{child.name}&apos;s Library</h3>
        ...
        {activeNav === 'children' && (
          <div style={{ maxWidth: '560px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '28px' }}>
              <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.4rem', color: '#0D183D', fontWeight: '400' }}>Children</h3>
              {sub?.status === 'subscribed' ? (
                    ...
                    <div key={child.id} style={{ background: '#fff', border: '1px solid #F0E4D0', borderRadius: '12px', padding: '20px', borderLeft: `4px solid ${palette.cover}` }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '4px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                          ...
                          <h4 style={{ fontFamily: 'Nunito, sans-serif', fontWeight: '600', color: '#0D183D' }}>{child.name}</h4>
                        </div>
        ...
        {activeNav === 'account' && (
          <div style={{ maxWidth: '480px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div>
              <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.4rem', color: '#0D183D', fontWeight: '400', marginBottom: '16px' }}>Account</h3>
            ...
            {/* Subscription */}
            <div>
              <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.4rem', color: '#0D183D', fontWeight: '400', marginBottom: '16px' }}>Subscription</h3>
              <div style={{ background: '#fff', border: '1px solid #F0E4D0', borderRadius: '12px', padding: '20px', marginBottom: '12px' }}>
            ...
            {/* Referral */}
            <div>
              <h3 style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1.4rem', color: '#0D183D', fontWeight: '400', marginBottom: '8px' }}>Refer a friend 🎁</h3>
