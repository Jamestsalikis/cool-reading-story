      ...
      <main style={{ maxWidth: '720px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
          ...
          <Section title="1. Who we are">
            <p>Cool Reading Story ("we", "us", "our") is an AI-powered personalised children&apos;s story service operated by [Your Company Name] ABN [XX XXX XXX XXX], based in Australia. We take your privacy — and the privacy of your children — seriously. This policy explains what information we collect, why we collect it, and how we protect it.</p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem', marginTop: '0.5rem' }}>
              <thead>
                <tr style={{ background: '#F5F0E8' }}>
                  <th style={{ padding: '0.625rem 0.75rem', textAlign: 'left', border: '1px solid #E8E3DC', fontWeight: 600, color: '#1C1614' }}>Processing activity</th>
                  <th style={{ padding: '0.625rem 0.75rem', textAlign: 'left', border: '1px solid #E8E3DC', fontWeight: 600, color: '#1C1614' }}>Legal basis</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} style={{ background: i % 2 === 0 ? 'white' : '#FAF9F6' }}>
                    <td style={{ padding: '0.625rem 0.75rem', border: '1px solid #E8E3DC', color: '#4A3728' }}>{activity}</td>
                    <td style={{ padding: '0.625rem 0.75rem', border: '1px solid #E8E3DC', color: '#4A3728' }}>{basis}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <Section title="4. Children's privacy">
            ...
            <p><strong>Your rights as a parent.</strong> You may at any time review, correct, or delete your child&apos;s profile through the app. To request a full export or deletion of your child&apos;s data, contact us at <a href="mailto:hello@coolreadingstory.com" style={{ color: '#741515' }}>hello@coolreadingstory.com</a>. We will respond within 30 days.</p>
          </Section>
          ...
          <Section title="6. Third-party services">
            ...
            <ul style={{ paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <li><strong>Supabase</strong> — database and authentication (<a href="https://supabase.com/privacy" style={{ color: '#741515' }}>supabase.com/privacy</a>)</li>
              <li><strong>Anthropic</strong> — AI story generation via the Claude API (<a href="https://www.anthropic.com/privacy" style={{ color: '#741515' }}>anthropic.com/privacy</a>)</li>
              <li><strong>Replicate</strong> — AI illustration generation (<a href="https://replicate.com/privacy" style={{ color: '#741515' }}>replicate.com/privacy</a>)</li>
              <li><strong>Stripe</strong> — payment processing (<a href="https://stripe.com/privacy" style={{ color: '#741515' }}>stripe.com/privacy</a>)</li>
              <li><strong>Vercel</strong> — hosting and deployment (<a href="https://vercel.com/privacy" style={{ color: '#741515' }}>vercel.com/privacy</a>)</li>
            </ul>
          ...
          <Section title="9. Your rights">
            ...
            <ul style={{ paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <li><strong>Australia:</strong> Office of the Australian Information Commissioner (OAIC) — <a href="https://www.oaic.gov.au" style={{ color: '#741515' }}>oaic.gov.au</a></li>
              <li><strong>United Kingdom:</strong> Information Commissioner&apos;s Office (ICO) — <a href="https://ico.org.uk" style={{ color: '#741515' }}>ico.org.uk</a></li>
