...
export default function StoryPage() {
  ...
  function renderPageContent() {
    if (isDesktop) {
      return (
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'stretch', flex: 1, minHeight: '460px' }}>
          <div style={{ flex: '0 0 44%', marginLeft: '28px', display: 'flex', flexDirection: 'column' }}>
            <div style={{ flex: 1, overflow: 'hidden', position: 'relative', minHeight: '380px', background: '#FFFEF9' }}>
              {illustrationEl}
              <CornerOrnaments />
            </div>
          </div>
          <div style={{ flex: 1, overflowY: 'auto', borderLeft: '1px solid rgba(13,24,61,0.08)', position: 'relative', zIndex: 2 }}>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <div style={{ marginLeft: '28px', width: 'calc(100% - 28px)', aspectRatio: '4 / 3', overflow: 'hidden', position: 'relative', flexShrink: 0 }}>
          {illustrationEl}
          <CornerOrnaments />
        </div>
        <div style={{ overflowY: 'auto', maxHeight: 'calc(100svh - 75vw - 175px)', minHeight: '150px', position: 'relative', zIndex: 2, WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
